package w2;
        ...
        После этого программа должна определить и сообщить пользователю о том, сумма модулей какой половины массива больше: левой или правой, либо сообщить,
...
public class Task_9 {
    public static void main(String[] args) {
        ...
        System.out.println("Enter even number, you have 20 attempts");
        int leftsum = 0;
        int rightsum = 0;
        for (int j = 0; j < 20; j++) {
